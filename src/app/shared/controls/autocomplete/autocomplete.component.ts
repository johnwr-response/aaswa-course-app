import {Component, forwardRef, Input, EventEmitter, OnDestroy, OnInit, Output} from '@angular/core';
import {ControlValueAccessor, FormControl, NG_VALUE_ACCESSOR} from "@angular/forms";
import {Observable, Subject} from "rxjs";
import {distinctUntilChanged, startWith, takeUntil, map, filter} from "rxjs/operators";
